    ...
    <section class="inner-page">
        <div class="container">
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo "<tr style='border: 1px solid black; padding: 10px;'><th>Nombre</th><th>Apellidos</th><th>Email</th><th>Presupuesto</th><th>Método de pago</th><th>Descripción</th><th>Imagen</th></tr>";
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    ...
                    echo "<td><img src='data:image/jpeg;base64," . base64_encode($fila["imagen"]) . "'/></td>";
                    echo "</tr>";
                }
                echo "</table>";
            } else {
